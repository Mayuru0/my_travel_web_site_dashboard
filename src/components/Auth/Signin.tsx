          ...
          <div className="p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
                ...
                <Link href="/forgot-password" className="text-xs sm:text-sm text-green-500 hover:underline">
                  Forgot password?
                </Link>
              </div>

              {errors.rememberMe && <p className="text-red-500 text-xs sm:text-sm">{errors.rememberMe}</p>}
